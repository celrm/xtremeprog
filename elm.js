...
var _user$project$Types$Model = F4(
	function (a, b, c, d) {
		return {todo: a, tareas: b, $eval: c, numerito: d};
	});
var _user$project$Types$Add = {ctor: 'Add'};
var _user$project$Types$Vuelta = {ctor: 'Vuelta'};
var _user$project$Types$Cambiar = F3(
	function (a, b, c) {
		return {ctor: 'Cambiar', _0: a, _1: b, _2: c};
	});
...
var _user$project$Styles$textStyle = F2(
	function (negrita, tam) {
		return _elm_lang$html$Html_Attributes$style(
			{
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'font-size', _1: tam},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Courier New'},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'font-weight',
								_1: negrita ? 'bold' : 'normal'
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Styles$nonselect = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
...
var _user$project$Styles$flexcontainer = function (rowcolumn) {
	return _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'flex-direction', _1: rowcolumn},
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Styles$fondo = '#F3F781';

var _user$project$Functions$emptycell = A2(
	_elm_lang$html$Html$td,
	{
		...
		_0: _elm_lang$html$Html_Attributes$style(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'background', _1: _user$project$Styles$fondo},
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	},
...
var _user$project$Functions$tarjeta = F3(
	function (h, i, _p0) {
		var _p1 = _p0;
		var _p2 = _p1._1;
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Functions$emptycell,
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$td,
								{
									...
									_0: _elm_lang$html$Html_Events$onClick(
										A3(_user$project$Types$Cambiar, _p2, h, i)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$style(
											{
										...
										_1: {
											ctor: '::',
											_0: A2(_user$project$Styles$textStyle, true, '20px'),
											_1: {
												ctor: '::',
												_0: _user$project$Styles$nonselect,
												_1: {ctor: '[]'}
											}
										}
									}
						...
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$td,
								{
									...
									_0: _elm_lang$html$Html_Attributes$style(
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'padding', _1: '0px 0px 0px 30px'},
													_1: {
														ctor: '::',
									...
									_1: {
										ctor: '::',
										_0: A2(_user$project$Styles$textStyle, true, '1.25em'),
										_1: {ctor: '[]'}
									}
								},
								{
						...
						_0: A2(
							_elm_lang$html$Html$tr,
							{
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'height', _1: '166px'},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$td,
									{
										...
										_1: {
											ctor: '::',
											_0: A2(_user$project$Styles$textStyle, false, '1em'),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$Functions$historia = F3(
	function (b, h, tareas) {
		var _p3 = tareas;
		var descripcion = _p3._0;
		var lista = _p3._1;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Styles$flexcontainer('column'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Styles$center,
						_1: {ctor: '[]'}
					}
				}
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'margin-bottom', _1: '14px'},
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Styles$textStyle, false, '1.5em'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(h + 1),
											':'))),
								_1: {ctor: '[]'}
							}),
						_1: {
							...
							_0: A2(
										...
										_0: _elm_lang$html$Html_Attributes$style(
											{
												...
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'text-align', _1: 'justify'},
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(descripcion),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Styles$flexcontainer(
								b ? 'column' : 'row'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
							...
							F2(
								function (i, tarea) {
									return A2(
										...
										{
											ctor: '::',
											_0: A3(_user$project$Functions$tarjeta, h, i, tarea),
											_1: {
												ctor: '::',
												_0: A2(
...
var _user$project$State$h4 = {
	ctor: '_Tuple2',
	_0: 'hola hola hola hola hola hola hola hola hola hola hola hola hola hola hola hola',
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'hola hola hola hola', _1: false},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'hola hola hola hola hola', _1: false},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'hola hola hola hola hola hola', _1: false},
				_1: {ctor: '[]'}
			}
		}
	}
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$Add),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Styles$textStyle, false, '0.75em'),
								_1: {
									ctor: '::',
									_0: _user$project$Styles$center,
									_1: {ctor: '[]'}
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Nuevo requisito'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Styles$flexcontainer('row'),
							_1: {ctor: '[]'}
						},
						A2(
							_elm_lang$core$List$indexedMap,
							_user$project$Functions$historia(model.$eval),
							model.tareas)),
					_1: {ctor: '[]'}
				}
			});
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$Styles$textStyle, true, '1.5em'),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Prueba y evaluación'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$Vuelta),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Volver al trabajo'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Functions$historia,
							model.$eval,
							model.numerito,
							A2(
								_elm_lang$core$Maybe$withDefault,
								...
								A2(_elm_community$list_extra$List_Extra$getAt, model.numerito, model.tareas))),
						_1: {ctor: '[]'}
					}
				}
			});
